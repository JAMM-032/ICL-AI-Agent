...
with_node \
  ...
  --target "/Users/yutaka_files/ICL-AI-Agent/ios/Pods/Target Support Files/Pods-ExpoAI/ExpoModulesProvider.swift" \
  --entitlement "/Users/yutaka_files/ICL-AI-Agent/ios/ExpoAI/ExpoAI.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-clipboard" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-quick-actions" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
